# code_snippets/keras/training.py

from tensorflow.keras.callbacks import EarlyStopping, ModelCheckpoint
from utilities.common_functions import load_config

def compile_and_train_keras_model(model, X_train, y_train, X_val, y_val, config=None):
    """
    ...
    callbacks = [
        ...
        ModelCheckpoint('best_keras_model.h5', monitor='val_loss', save_best_only=True)
    ]
